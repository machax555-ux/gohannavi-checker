    ...
    <main className="h-full flex flex-col justify-between overflow-hidden py-1">
      ...
      <header className="flex flex-col gap-2 shrink-0">
        ...
        <div className="flex flex-col gap-0.5 mt-0.5">
          <h1 className="font-display font-black text-3.5xl sm:text-4xl leading-none tracking-tight text-[#111111]">
            FOOD CHECKER
          </h1>
          <p className="text-[11px] sm:text-xs font-black text-[#111111] tracking-wider mt-0.5">
            添加物をAIが瞬時に判定するスキャンツール
          </p>
        </div>

        <div className="w-full h-[2.5px] bg-[#111111]" />
      </header>

      {/* 2. Main Hero Cards (Full Original Swiss 70s Style with Compact Gaps) */}
      <div className="flex flex-col gap-2.5 my-auto shrink-0">
        ...
        {/* 02. DATABASE Card */}
        <div className="swiss-card-white p-3.5 flex flex-col gap-1.5">
          <div className="flex items-center justify-between">
        ...
        {/* 03. HOW IT WORKS Section (Full Original Vertical Step List with Revised Copy) */}
        <section className="swiss-card-white p-3.5 flex flex-col gap-2">
          <h3 className="font-display font-black text-xs text-[#111111] tracking-widest border-b-2 border-black pb-1 flex items-center justify-between">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-start gap-2.5">
              ...
              <div>
                ...
                <p className="text-[10px] text-[#444444] font-medium leading-tight">AIが食品添加物を検出</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2.5">
              ...
              <div>
                ...
                <p className="text-[10px] text-[#444444] font-medium leading-tight">Amazonで買えるおすすめの無添加商品</p>
              </div>
            </div>
          </div>
        </section>
      ...
      {/* 4. Footer */}
      <footer className="pt-1.5 border-t-2.5 border-black flex items-center justify-between text-xs shrink-0">
        <a
          href="https://gohannavi.com"
          target="_blank"
          rel="noopener noreferrer"
