...
(async () => {
        ...
        <div class="outer-card">
          <div class="content-container">
            <div class="line1">
              ...
              <img src="${logoDataUri}" class="emblem-img" alt="gohannavi emblem" />
            </div>
            <div class="line2">CHECKER</div>
          </div>
        </div>
      </body>
      </html>
  ...
  await generateIcon(512, path.join(publicDir, 'pwa-icon.png'));
  ...
  await browser.close();
  console.log('All FOOD CHECKER 2-line design PWA app icons generated successfully!');
})();
